...
export const OxfordResumeTemplate = ({ formValues, templateColorEnum }: IOxfordResumeTemplate) => {
  if (!formValues) {
    return null
  }
  ...
  return (
    <FormContext.Provider value={formValues}>
      <ResumePage style={merge([cs._MerriweatherFontFamily])}>
...
const templateColorStyle = (templateColorEnum) => {
  const templateColorStyles = {
    [ResumesTemplateColorEnum.OxfordCyan]: [styles.cyan],
    [ResumesTemplateColorEnum.OxfordEmerald]: [styles.emerald],
    [ResumesTemplateColorEnum.OxfordIndigo]: [styles.indigo],
    [ResumesTemplateColorEnum.OxfordLight]: [],
  }

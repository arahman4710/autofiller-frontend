...
const documents = {
    ...
    "mutation NewPageCheckDialog_createPageCheck($url: String!, $checkInterval: PageCheckIntervalEnum!, $resultType: PageCheckResultTypeEnum!, $pageCheckType: PageCheckTypeEnum!, $prompt: String, $multiplePages: Boolean!) {\n  createPageCheck(\n    url: $url\n    checkInterval: $checkInterval\n    resultType: $resultType\n    pageCheckType: $pageCheckType\n    prompt: $prompt\n    multiplePages: $multiplePages\n  ) {\n    id\n  }\n}": types.NewPageCheckDialog_CreatePageCheckDocument,
 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "mutation NewPageCheckDialog_createPageCheck($url: String!, $checkInterval: PageCheckIntervalEnum!, $resultType: PageCheckResultTypeEnum!, $pageCheckType: PageCheckTypeEnum!, $prompt: String, $multiplePages: Boolean!) {\n  createPageCheck(\n    url: $url\n    checkInterval: $checkInterval\n    resultType: $resultType\n    pageCheckType: $pageCheckType\n    prompt: $prompt\n    multiplePages: $multiplePages\n  ) {\n    id\n  }\n}"): (typeof documents)["mutation NewPageCheckDialog_createPageCheck($url: String!, $checkInterval: PageCheckIntervalEnum!, $resultType: PageCheckResultTypeEnum!, $pageCheckType: PageCheckTypeEnum!, $prompt: String, $multiplePages: Boolean!) {\n  createPageCheck(\n    url: $url\n    checkInterval: $checkInterval\n    resultType: $resultType\n    pageCheckType: $pageCheckType\n    prompt: $prompt\n    multiplePages: $multiplePages\n  ) {\n    id\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
